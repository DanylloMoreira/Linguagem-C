...
#include<stdlib.h>//Biblçioteca padrão para uso de funções do sistema
...
tipo int identificado por %d que será armazernado no espaço reservado para
...
que será armazenado no espaço reservado para num_alunos, &num_alunos */
	...
	getch(); //Função que aguarda o reconhecimenti de um caractere via teclado. 	    
}
